...
public class FraserValleyExpressBusAgencyTools extends DefaultAgencyTools {
	...
	public void start(@NotNull String[] args) {
		MTLog.log("Generating Fraser Valley Express bus data...");
		long start = System.currentTimeMillis();
		this.serviceIdInts = extractUsefulServiceIdInts(args, this, true);
		super.start(args);
		MTLog.log("Generating Fraser Valley Express bus data... DONE in %s.", Utils.getPrettyDuration(System.currentTimeMillis() - start));
	}
